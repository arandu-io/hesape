...
//
// To run it: brew services start mysql, then
// create the database once:
//
//	mysql -uroot -e "CREATE DATABASE arandu_test"
//
// and run:
//
//	ARANDU_TEST_MYSQL_DSN="root@tcp(127.0.0.1:3306)/arandu_test?parseTime=true\&loc=UTC" go test ./...
func TestConformance(t *testing.T) {
	conformance.Run(t, database.DialectMySQL, driverName(t), dsn())
}
...
func dsn() string { return os.Getenv("ARANDU_TEST_MYSQL_DSN") }
